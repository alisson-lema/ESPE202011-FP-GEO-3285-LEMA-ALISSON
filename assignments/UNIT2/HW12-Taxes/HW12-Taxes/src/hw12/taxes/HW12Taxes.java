...
public class HW12Taxes {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println(" SERVIVIO DE RENTAS INTERNAS ( SRI) ");
            System.out.println("1. CALCULATION THE  IVA ");
            System.out.println("2. CALCULATION THE INCOME TAX ");
            System.out.println("3. CALCULATION THE ISD TAX ");
            ...
            switch (option) {
                case 1:
                    ...
                    finalSum = sumBasicProducts + (sumNonBasicProducts + VATValue);
